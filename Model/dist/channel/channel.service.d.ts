...
export declare class ChannelService {
    ...
    createChannel(createChannelDto: Partial<Channel>, owner: Number): Promise<Channel>;
    ...
    muteUser(channelID: Number, userID: Number, initiatorID: Number, amount: number): Promise<ChannelMembership>;
    banUser(channelID: Number, userID: Number, initiatorID: Number, amount: number): Promise<ChannelMembership>;
    unmuteUser(channelID: Number, userID: Number): Promise<ChannelMembership>;
    unbanUser(channelID: Number, userID: Number): Promise<ChannelMembership>;
    getAllChannels(): Promise<Channel[]>;
    getChannel(channelID: Number): Promise<Channel>;
    checkPassword(channelID: Number, password: String): Promise<Boolean>;
    hashPassword(password: String): Promise<String>;
    private validateInvitationLink;
