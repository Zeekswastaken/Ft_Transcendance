...
const Inputs: React.FC<Props> = ({ label, exContent, type }) => {
  let inputType;
  if (type === "select") {
    inputType = <select defaultValue={exContent} id="Privacy" name="Privacy" autoComplete="off" className="shadow-base fonct-Heading tracking-wider bg-[#562257] sm:text-sm  rounded-2xl placeholder:text-[#B1B1B1] placeholder:font-bold placeholder:text-base w-full h-[50px] ">
                  <option value="Public">Public</option>
                  <option value="Private">Private</option>
                </select>;
  }
  else {
    inputType = <input type={type} name={type} id={type} autoComplete="off" className=" fonct-Heading tracking-wider bg-[#562257] w-full h-[50px] sm:text-sm  rounded-2xl placeholder:text-[#B1B1B1] placeholder:font-bold placeholder:text-base" placeholder={exContent} />;}
  return (
    <div>
      <label
        htmlFor={label}
        ...
        <div className=" flex place-content-center">
          <div className="  w-[78%] h-auto pb-20">
            <div className=" overflow-hidden whitespace-wrap">
              <h1 className=" pt-20 text-white font-Bomb text-4xl">
                Account Settings
              </h1>
            </div>
            <div className="bg-[#2F0331] w-full grid grid-cols-1  2xl:grid-cols-3 mt-5 rounded-2xl opacity-90 border border-primary-pink-300">
              ...
              <div className="  p-20 grid col-span-2 space-y-4">
