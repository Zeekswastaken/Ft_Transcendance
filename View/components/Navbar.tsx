...
const Navbar = () => {
	...
	return (
		// Desktop Navigation
		// <div className=" ">
			<nav className=" hidden absolute place-content-center  items-center mt-[30px] mb-[55px] h-auto lg:flex w-[80%] justify-between space-x-5 z-20  p-3 rounded-xl glass">
