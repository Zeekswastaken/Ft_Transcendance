...
const DiscriptionCard = () => {
  return (
    <header className=" animate-fade-up bg-[url('/girl.png')] mt-[200px] min-w-[350px] flex mx-5 sm:mx-[100px] bg-cover bg-no-repeat bg-center h-auto overflow-hidden whitespace-wrap rounded-[34px]">
