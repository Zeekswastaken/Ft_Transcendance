   ...
   */ const generateStaticHTML = supportsDynamicHTML !== true;
     ...
     */ const createServerComponentsRenderer = (loaderTreeToRender, preinitScripts)=>(0, _createservercomponentsrenderer.createServerComponentRenderer)(async (props)=>{
        ...
        const bodyResult = (0, _tracer.getTracer)().wrap(_constants.AppRenderSpan.getBodyResult, {
            ...
            const [preinitScripts, bootstrapScript] = (0, _requiredscripts.getRequiredScripts)(buildManifest, assetPrefix, subresourceIntegrityManifest, getAssetQueryString(true));
            ...
            try {
                ...
                const [errorPreinitScripts, errorBootstrapScript] = (0, _requiredscripts.getRequiredScripts)(buildManifest, assetPrefix, subresourceIntegrityManifest, getAssetQueryString(false));
